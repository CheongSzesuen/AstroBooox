          ...
          <CardContent class="flex flex-wrap items-start gap-2.5 px-3 pb-3 pt-3 sm:gap-4 sm:p-6 sm:pt-4">
            ...
            >
              ...
              <img
                ...
                alt="Cover 预览"
                class="mt-1 h-auto max-h-[30vh] w-full rounded-md border border-border object-contain transition-opacity group-hover:opacity-90"
                loading="lazy"
              />
            </a>
          </CardContent>
                  ...
                  >
                    <div class="flex items-start gap-1.5 sm:gap-2">
                      ...
                      <div class="min-w-0">
                        ...
                        <div class="break-words text-xs text-muted-foreground">{{ item.detail }}</div>
                      </div>
                    </div>
                  </div>
                </div>
